...
export default function ExecutionsPage() {
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-green-500 to-teal-600 rounded-2xl p-12 text-center text-white shadow-2xl">
                <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <Zap className="w-10 h-10" />
                </div>
                <h2 className="text-3xl font-bold mb-4">Próximamente</h2>
                <p className="text-lg opacity-90 mb-6">
                    Historial de ejecuciones estará disponible pronto
                </p>
